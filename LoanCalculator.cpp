...
void LoanCalculator::setAmount(float A)
{
  amount_ = A;
  amountSet_ = true;
}

float LoanCalculator::getAmount()
{
  return amount_;
}

void LoanCalculator::setInitialPayment(float initialA)
{
  initialPayment_ = initialA;
}

float LoanCalculator::getInitialPayment()
{
  return initialPayment_;
}

void LoanCalculator::setInterest(float i)
{
  interest_ = i;
...
float LoanCalculator::getInterest()
{
  return interest_;
}

float LoanCalculator::getPeriodicInterest()
{
  return interestPeriodic_;
}

void LoanCalculator::setPayment(float P)
{
  payment_ = P;
  paymentSet_ = true;
}

float LoanCalculator::getPayment()
{
  return payment_;
}
...
int LoanCalculator::getPeriodTotal()
{
  return periodTotal_;
}
...
int LoanCalculator::getPeriodElapsed()
{
  return periodElapsed_;
}

void LoanCalculator::setOpeningFee(float fee)
{
  openingFee_ = fee;
}

float LoanCalculator::getOpeningFee()
{
  return openingFee_;
}

void LoanCalculator::setOpeningPercent(float percent)
{
  openingPercent_ = percent;
}

float LoanCalculator::getOpeningPercent()
{
